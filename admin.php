...
<body style="padding: 0; margin: 0;display: flex;justify-content:center;align-items:center">
    ...
    <div style="width:400px;height:600px;margin-top:50px;display:flex;flex-direction:column;align-items:center">
         <img src="img/panel.png" class="img-thumbnail" style="width: 200px;">
